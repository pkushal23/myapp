"""
Django settings for newsletter_agent project.
...
SECRET_KEY = 'django-insecure-81zwkhg95j1_c*r1#z#vfpwgt%(gxni6qh!xelfk*e)(zgqw6y'
...
ROOT_URLCONF = 'newsletter_agent.urls'
...
WSGI_APPLICATION = 'newsletter_agent.wsgi.application'
